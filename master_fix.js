(()=>{'use strict';
/* FINAL LOADER v22: persistence only, never rewrites fighter records. */
...
const s=document.createElement('script');s.src='stabilizer_v21.js?v=22.1';s.onload=()=>{try{window.__RATING_V22_LOADED__=true}catch(e){}};document.body.appendChild(s);
})();
